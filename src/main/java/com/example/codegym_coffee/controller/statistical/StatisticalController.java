...
public class StatisticalController {
    ...
    @GetMapping("")
    public ResponseEntity<?> getStatistic(@RequestParam String dateAfter, @RequestParam String dateBefore ){
        ...
        List<StatisticDTO> entityStatisticDTOS  = iStatisticalService.getListStatistical(date,date1);
