...
public class BillRestController_search_code {
    @Autowired
    private MockMvc mockMvc;

    /**
     * Test case find bill code with null parameter
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test case finds bill code with empty parameter
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test case finds bill code whose parameter does not exist in the database
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test case find bill code whose parameter exists in database
     *
     * @throws Exception
     */
    @Test
    public void search_code_5() throws Exception {
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get("/api/admin/bill/code/HD01"))
                .andDo(print())
