...
public class HomePageRestController_getListProduct {
    ...
    public void getTopProduct_6() throws Exception {
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("[0].nameProduct").value("Cafe 4"))
                .andExpect(jsonPath("[0].price").value(10000))
                .andExpect(jsonPath("[0].ingredient").value("Cafe 4 good"))
                .andExpect(jsonPath("[1].nameProduct").value("Cafe 8"))
                .andExpect(jsonPath("[1].price").value(10000))
                .andExpect(jsonPath("[1].ingredient").value("Cafe 8 good"))
                ...
                .andExpect(jsonPath("[4].nameProduct").value("Cafe 6"))
                .andExpect(jsonPath("[4].price").value(10000))
                .andExpect(jsonPath("[4].ingredient").value("Cafe 6 good"));
    ...
    public void getNewProduct_6() throws Exception {
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("[4].nameProduct").value("Cafe4"))
                .andExpect(jsonPath("[4].price").value(10000))
